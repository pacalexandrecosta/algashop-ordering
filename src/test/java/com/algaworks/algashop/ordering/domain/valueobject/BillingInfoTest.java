...
class BillingInfoTest {
    ...
    void given_null_full_name_when_creating_should_throw_exception() {
        Assertions
                ...
                .isThrownBy(() -> new BillingInfo(null, validDocument, validPhone, validAddress));
    }
    ...
    void given_null_document_when_creating_should_throw_exception() {
        Assertions
                .assertThatExceptionOfType(NullPointerException.class)
                .isThrownBy(() -> new BillingInfo(validFullname, null, validPhone, validAddress));
    }
    ...
    void given_null_phone_when_creating_should_throw_exception() {
        Assertions
                .assertThatExceptionOfType(NullPointerException.class)
                .isThrownBy(() -> new BillingInfo(validFullname, validDocument, null, validAddress));
    }
    ...
    void given_null_address_when_creating_should_throw_exception() {
        Assertions
                .assertThatExceptionOfType(NullPointerException.class)
                .isThrownBy(() -> new BillingInfo(validFullname, validDocument, validPhone, null));
    }
